...
function db_insert($table, $data) {
    ...
    foreach ($data as $value) {
        // Escape string để tránh lỗi cú pháp hoặc SQL injection
        $values[] = "'" . pg_escape_string($connection, $value) . "'";
    }
    ...
    if (!$result) {
        echo "❌ Insert error: " . pg_last_error($connection);
    } else {
...
function db_delete_table($table) {
    global $conn;
