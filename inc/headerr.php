...
$user_id_active = 0;
$username_active = "";
$img_user_active = "../public/img/account/";
$account_type_active = "";
$cart_id_active = 0;
    ...
    <div id="wrapper">
        ...
        <div id="header">
            <ul id="main_menu_bar" style="padding: 0;">
                ...
                <li class="menu_item"><a href="">Other</a>
                    <div class="hover_content">
                        ...
                        <div class="right_column">
                            <h4>FRAGRANCES</h4>
                            <ul>
                                <li style="display: block;"><a style=' padding: 0 !important;font-family: "Montserrat", sans-serif !important;font-size: 13px !important;font-weight: 400 !important;width: fit-content !important;' href="../modules/purchase_history.php">View Purchase History</a></li>
                ...
                <li><a href="../modules/admin_panel_staff/blog.php">Blog</a></li>
                ...
                <li class="side_menu_user">
                    ...
                    <div class="hover_content_user">
                        <div class="user_active_infor">
                            <img src="<?php echo $img_user_active ?>" alt="img_user_active">
