...
<div class="counter">
    <form style="display:flex; align-items: center;" action="../cart.php" method="POST">
        <span name="cnt" class="down" onClick="decreaseCount(event, this)">-</span>
        <input type="text" value="<?php echo $value['quantity'] ?>" name='quantityNum'>
        <?php //echo $_POST['quantityNum'] ?>
        <span name="cnt" class="up" onClick="increaseCount(event, this)">+</span>
