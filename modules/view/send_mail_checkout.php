...
try {
    ...
    $mail->addAddress($email_login, 'Nguyễn Hữu Quỳnh Anh');     //Add a recipient
    ...
    $mail->Body    = "Welcome to Style Seeker fashion shop ! <br>Your exclusive profile code is: {$num}.<br> Please enter this code to proceed with your payment.";
